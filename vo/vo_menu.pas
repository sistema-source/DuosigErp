    ...
    begin
      ...
      begin
        ...
        begin
          ...
          OpcaoMenu.isCreate := OpcaoObject.Get('criar', 0);
          OpcaoMenu.isRead := OpcaoObject.Get('ler', 0);
          OpcaoMenu.isUpdate := OpcaoObject.Get('editar', 0);
          OpcaoMenu.isDelete := OpcaoObject.Get('apagar', 0);
          OpcaoMenu.isPrint := OpcaoObject.Get('print', 0);
